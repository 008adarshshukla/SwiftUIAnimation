...
var products: [Product] = [
    // Apple Watch
    Product (type: .appleWatch, title: "Apple Watch", subtitle: "Ultra: Alphine Loop", price: "$999", productImage:
                "AppleWatchUltra"),
    ...
    Product (type: .appleWatch, title: "Apple Watch", subtitle: "Series 4: Black", price: "$250", productImage:
                "AppleWatch4"),
    // iPhone's
    ...
    // MacBook's
    Product (type: .macbook, title: "MacBook Pro 16", subtitle: "M2 Max - silver", price: "$2499", productImage:
                "MacBookPro16"),
    Product (type: .macbook, title: "MacBook Pro", subtitle: "MI - Space Grey", price: "$1299", productImage: "MacBookPro"),
    Product (type: .macbook, title: "MacBook Air", subtitle: "MI - Gold", price: "$999", productImage: "MacBookAir"),
    
    // iPad's
    Product (type: .ipad, title: "iPad Pro", subtitle: "MI - Silver", price: "$999", productImage: "iPadPro"),
    ...
    // Desktop's
    Product (type: .desktop, title: "Mac Studio", subtitle: "MI Max - silver", price: "$1999", productImage: "MacStudio"),
    Product (type: .desktop, title: "Mac Mini", subtitle: "M2 Pro - Space Gray", price: "$999", productImage: "MacMini"),
    Product (type: .desktop, title: "iMac", subtitle: "MI - Purple", price: "$1599", productImage: "iMac"),
